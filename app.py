...
app.py ÃÂ¢ÃÂÃÂ Definite Assurance Claims Portal
Stackwire / Definite Assurance ÃÂ¢ÃÂÃÂ Phase 2 (Railway Migration)
"""
import sys, os
...
PAGE_STRUCTURE = {
    "ÃÂ°ÃÂÃÂÃÂ  Home": [],
    "ÃÂ°ÃÂÃÂÃÂ Claimant Portal": [
...
ROLE_ACCESS = {
    "client":           ["ÃÂ°ÃÂÃÂÃÂ  Home", "ÃÂ°ÃÂÃÂÃÂ Claimant Portal"],
    "claims_officer":   ["ÃÂ°ÃÂÃÂÃÂ¥ Intake Panel", "ÃÂ°ÃÂÃÂÃÂ Claimant Portal"],
    "head_of_claims":   ["ÃÂ°ÃÂÃÂÃÂ¥ Intake Panel", "ÃÂ¢ÃÂÃÂÃÂ¯ÃÂ¸ÃÂ Operations"],
    "assessor":         ["ÃÂ°ÃÂÃÂÃÂ§ Provider Panel"],
    "investigator":     ["ÃÂ°ÃÂÃÂÃÂ§ Provider Panel"],
    "garage":           ["ÃÂ°ÃÂÃÂÃÂ§ Provider Panel"],
    "spare_parts":      ["ÃÂ°ÃÂÃÂÃÂ§ Provider Panel"],
    "finance":          ["ÃÂ°ÃÂÃÂÃÂ¦ Finance"],
    "legal":            ["ÃÂ¢ÃÂÃÂÃÂ¯ÃÂ¸ÃÂ Legal"],
    "admin":            ["ÃÂ°ÃÂÃÂÃÂ¡ÃÂ¯ÃÂ¸ÃÂ Admin Console", "ÃÂ°ÃÂÃÂÃÂ¦ Finance", "ÃÂ¢ÃÂÃÂÃÂ¯ÃÂ¸ÃÂ Legal", "ÃÂ¢ÃÂÃÂÃÂ¯ÃÂ¸ÃÂ Operations"],
    "super_admin":      ["ÃÂ°ÃÂÃÂÃÂ¡ÃÂ¯ÃÂ¸ÃÂ Admin Console", "ÃÂ°ÃÂÃÂÃÂ¦ Finance", "ÃÂ¢ÃÂÃÂÃÂ¯ÃÂ¸ÃÂ Legal", "ÃÂ¢ÃÂÃÂÃÂ¯ÃÂ¸ÃÂ Operations", "ÃÂ°ÃÂÃÂÃÂ¥ Intake Panel", "ÃÂ°ÃÂÃÂÃÂ§ Provider Panel", "ÃÂ°ÃÂÃÂÃÂ Claimant Portal"],
    "cfo":              ["ÃÂ°ÃÂÃÂÃÂ¦ Finance", "ÃÂ°ÃÂÃÂÃÂ¡ÃÂ¯ÃÂ¸ÃÂ Admin Console"],
    "manager":          ["ÃÂ°ÃÂÃÂÃÂ¡ÃÂ¯ÃÂ¸ÃÂ Admin Console"],
    "surveyor":         ["ÃÂ°ÃÂÃÂÃÂ§ Provider Panel"],
    "motor_fleet":      ["ÃÂ°ÃÂÃÂÃÂ Claimant Portal"],
}
...
def login_page() -> None:
    st.html("<div style='text-align:center;margin-bottom:1rem'><h1>ÃÂ°ÃÂÃÂÃÂ¢ Definite Assurance</h1><p style='color:#666'>Claims Management Portal</p></div>")
...
def sidebar_nav() -> str:
    ...
    st.sidebar.divider()
    if st.sidebar.button("ÃÂ°ÃÂÃÂÃÂª Sign Out"):
        auth.logout()
        st.rerun()
    return selected
...
def main() -> None:
    st.set_page_config(page_title="Definite Assurance ÃÂ¢ÃÂÃÂ Claims Portal", page_icon="ÃÂ°ÃÂÃÂÃÂ¢", layout="wide")
    init()
